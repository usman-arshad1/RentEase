describe('announcement', () => {
    ...
    it('create announcement', () => {
        ...
        cy.get('[data-cy="announcement-submitted"]').should('be.visible').contains('Announcement successfully submitted');
    })

    it('empty announcement', () => {
        cy.get('[data-cy="announcement-button"]').click();
        cy.get('[data-cy="announcement-create"]').click();
        cy.get('[data-cy="announcement-invalid"]').should('be.visible').contains('Enter an announcement');
    })

    it('view announcement', () => {
        cy.get('[data-cy="announcement-view"]').should('be.visible');
        cy.get('[data-cy="announcement-view"]').should('be.visible').first().within(() => {
    ...
    it('delete announcement', () => {
        ...
        cy.get('[data-cy="announcement-deleted"]').should('be.visible').contains('Announcement successfully removed');
    })
